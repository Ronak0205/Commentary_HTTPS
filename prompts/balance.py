...
1. Identify the denomination (thousands/millions) from the table header.
   ...
   Equity ≈ Total Assets. If not, re-read for the correct unit.
...
4. If Undivided Earnings alone appears to exceed Total Equity, that is a
   misread unit — re-read before writing. If unresolvable, report only
   Total Equity.
...
USER_PROMPT = """
Read the attached balance sheet image. Identify the institution name and
dollar denomination. Extract exact figures and % changes for: Total Assets,
Cash & Deposits, Investment Securities, Loans & Leases, Other Assets, Total
Liabilities, Shares/Deposits, Accrued Liabilities, Other Liabilities, Total
Equity, Undivided Earnings, and Reserves.
